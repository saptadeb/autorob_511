...
robot.joints.leg6_hip.origin = {xyz: [0.3,0.0,0], rpy:[0,Math.PI/2,0]};
...
robot.joints.leg8_hip.origin = {xyz: [-0.3,0.0,0.0], rpy:[0,-Math.PI/2,0]};
...
robot.joints.clavicle_right_yaw.origin = {xyz: [0.0,0.0,0.9], rpy:[-Math.PI/2,0,0]};
...
robot.joints.shoulder_right_yaw.origin = {xyz: [0.0,-0.15,1.15], rpy:[Math.PI/2,0,0]};
...
robot.joints.upperarm_right_pitch.origin = {xyz: [0.0,0.03,0.80], rpy:[-Math.PI/4,0,0]};
...
robot.joints.clavicle_left_roll.origin = {xyz: [0.0,0.0,-0.9], rpy:[-Math.PI/2,0,0]};
robot.joints.clavicle_left_roll.axis = [0.0,0.0,1.0]; 

robot.joints.shoulder_left_yaw = {parent:"clavicle_left", child:"shoulder_left"};
robot.joints.shoulder_left_yaw.origin = {xyz: [0.0,0.15,1.15], rpy:[-Math.PI/2,0,0]};
